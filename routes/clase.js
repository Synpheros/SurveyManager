module.exports = function(auth){
	...
	router.get('/pdf/:class_id', auth(2), function(req, res, next) {
		...
		classroom.load(function(err, result){
			...
			var html = '<!DOCTYPE html><html><head><title></title><style type="text/css">body{padding:10px;} table{font-size: 20pt;font-family: Courier New;border: solid 2px black;border-collapse: collapse;}table td{border: solid 2px black;text-align: center;}</style></head>';
